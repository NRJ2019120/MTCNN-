...
class detector():
    def __init__(self
                 ...
                 ,onet_parampath= r"/home/tensorflow01/oneday/celeba/landmarks_params/o-net_another.pkl"
                 ,iscuda=False):
    ...
    def pnet_detect(self,image):    #image CHW   每12*12, 判断一次 ,扫描 通过卷积完成
        ...
        while min_side_len > 12:      #img 转化成cHw 三维张量
            ...
            for idx in idxs:
                ...
                boxes.append(self.__box(idx, offset, con[idx[0], idx[1]], scale))  #坐标反算
            # print("boxes==>",boxes)
...
if __name__ == '__main__':
    ...
    for epoch in range(20,35):
        ...
        for box in boxes:
            ...
            # print((x1, y1, x2, y2))
            # img.save(r"/home/tensorflow01/oneday/mtcnn 三网络均卷积/test_img_result/{}.jpg".format(epoch))
        img.show()
